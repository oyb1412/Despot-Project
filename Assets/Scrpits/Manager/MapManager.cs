...
public class MapManager : MonoSingleton<MapManager>
{
    ...
    public RoomType CurrentMapType;
    ...
    public void GenerateMap() {
        ...
        rooms[startPos].type = RoomType.Combat; // 시작방 = 보상방
        ...
        BattleStateManager.Instance.ChangeType(BattleStateType.Idle);
    ...
    public void MoveMap(bool vis, Vector2Int pos, MiniMapRoomIcon miniMap) {
        ...
        CurrentMapType = rooms[pos].type;
        BattleStateManager.Instance.ChangeType(BattleStateType.Idle);
        ResourcesManager.Instance.UseFood(PlayerCretureManager.Instance.UnitSlotManager.GetTotalUnitCount());
